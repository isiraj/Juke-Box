  ...
  render () {
    return (
      <div id='main' className='row container'>
        ...
        {this.state.loaded === true ? <SingleAlbum album_data = {this.state.selectedAlbum} playSong = {this.playSong} songPlaying = {this.state.songPlaying}/> : <AllAlbums album_data = {this.state.albums} handleClick = {this.albumSelected}/>}
