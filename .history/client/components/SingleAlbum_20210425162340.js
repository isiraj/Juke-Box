    ...
    render(){
        ...
        return(
            <div className='container'>
                ...
                <Songs songPlaying = {this.props.songPlaying} handleClick = {this.props.playSong} songsInfo = {this.props.album_data[0].songs} songArtist = {this.props.album_data[0]["artist"]["name"]}/>
            </div>
        )
    }
}
