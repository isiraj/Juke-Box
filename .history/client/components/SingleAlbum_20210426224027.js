    ...
    render(){
        ...
        return(
            <div className='container'>
                ...
                <Songs handleClick = {this.props.playSong} playingState = {this.props.songPlaying} currentSong = {this.props.currentSong} songsInfo = {this.props.album_data[0].songs} songArtist = {this.props.album_data[0]["artist"]["name"]}/>
            </div>
        )
    }
}
