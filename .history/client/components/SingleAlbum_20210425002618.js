...
class SingleAlbum extends React.Component{
    ...
    render(){
        console.log(this.props.album_data[0]["id"])
        return(
            <div className='container'>
                <div id='albums' className='row wrap'>
                    ...
                    {this.props.album_data.map((album) => <Album key={["id"]} info = {{album_cover: album["artworkUrl"], album_name: album["name"], artist_name: album["artist"]["name"]}}/>)}
                </div>
            </div>
        )
    }
