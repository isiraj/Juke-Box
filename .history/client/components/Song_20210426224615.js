...
class Song extends React.Component{
    ...
    render(){
        ...
        return(
            <tr>
                <td><i className={this.props.playingState === true ? 'fa fa-pause-circle' : 'fa fa-play-circle'} onClick = {() => {this.props.songAudio(this.props.info.audioUrl, this.props.info)}}/></td>
